...
description: Apply Bulletproof React architecture and production-oriented React practices, including feature-based structure, colocation, unidirectional dependencies, component composition, state boundaries, TypeScript, testing, and API layering.
metadata:
  source: https://github.com/alan2207/bulletproof-react/blob/master/AGENTS.md
---
